<?php
/**
 * Architect theme plugin
 *
 * @package ArchitectTheme
 */

elgg_register_event_handler('init','system','architect_theme_init');

function architect_theme_init() {

	elgg_register_event_handler('pagesetup', 'system', 'architect_theme_pagesetup', 1000);

	// theme specific CSS
	elgg_extend_view('elgg.css', 'architect-theme/css');
 ...
 */
function architect_theme_pagesetup() {
 ...
 * @return array
 */
function architect_theme_setup_head($hook, $type, $data) {
	...
	$data['links']['apple-touch-icon'] = array(
		...
		'href' => elgg_get_simplecache_url('architect-theme/homescreen.png'),
	);
